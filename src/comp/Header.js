    ...
    <header id="header">
      <nav className="navbar navbar-expand-lg container-fluid mt-2 justify-content-center sticky-top">
        <div className="container text-center">
          ...
          <div
            className={`offcanvas offcanvas-end full-height ${
              props.mode === 'light' ? 'offcanvas-light' : 'offcanvas-dark'
            }`}
            tabIndex="-1"
            id="offcanvasNavbar"
          ...
          >
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li className="nav-item px-2">
                  <a className="nav-link text-reset" href="#services">
                    <b>SERVICES</b>
                  </a>
                </li>
                <li className="nav-item px-2">
                  <a className="nav-link text-reset" href="#internship">
                    <b>INTERNSHIPS</b>
                  </a>
                </li>
                <li className="nav-item px-2">
